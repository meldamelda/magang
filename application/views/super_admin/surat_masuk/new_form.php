		...
		<div id="content-wrapper">
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<!-- card-header -->
					<div class="card-body">
						<form action="<?php base_url('super_admin/surat_masuk/add') ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nomor_surat') ? 'is-invalid':'' ?>" type="text" name="nomor_surat" placeholder="Nomor Surat">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('disposisi') ? 'is-invalid':'' ?>" type="text" name="disposisi" placeholder="Disposisi">
								<div class="invalid-feedback">

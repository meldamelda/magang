								...
								<tbody>
									...
									<?php foreach($surat_keluar as $surat_keluar): ?>
										<tr>
											...
											<td>
												<a href="<?php echo site_url('super_admin/surat_keluar/unduh/'.$surat_keluar->file) ?>" class="btn btn-small text-info">
													<i class="fas fa-download"></i>
												</a>
											</td>
											<td width="250">
												<a href="<?php echo site_url('super_admin/surat_keluar/edit/'.$surat_keluar->id) ?>" class="btn btn-small text-melda3">
													<i class="fas fa-edit"></i>
													Edit
												</a>
												<a onclick="deleteConfirm('<?php echo site_url('super_admin/surat_keluar/delete/'.$surat_keluar->id) ?>')" href="#" class="btn btn-small text-danger">

								...
								<tbody>
									...
									<?php foreach($undangan as $undangan): ?>
										<tr>
											...
											<td width="13%">
												<a href="<?php echo site_url('admin/undangan/edit/'.$undangan->no) ?>" class="btn btn-small text-melda1">
													<i class="fas fa-edit"></i>
													Edit
												</a>
												<a onclick="deleteConfirm('<?php echo site_url('admin/undangan/delete/'.$undangan->no) ?>')" href="#" class="btn btn-small text-danger">

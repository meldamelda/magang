			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/undangan/') ?>">
					...
					<!-- card-header -->
					<div class="card-body">
						<form action="<?php base_url('admin/undangan/edit') ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tgl_diterima') ? 'is-invalid':'' ?>" type="date" name="tgl_diterima" placeholder="Tanggal diterima" value="<?php echo $undangan-> ?>">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('pengirim') ? 'is-invalid':'' ?>" type="text" name="pengirim" placeholder="Pengirim" value="<?php echo $undangan-> ?>">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tgl_acara') ? 'is-invalid':'' ?>" type="datetime-local" name="tgl_acara" placeholder="Tanggal Acara" value="<?php echo $undangan-> ?>">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('yg_hadir') ? 'is-invalid':'' ?>" type="text" name="yg_hadir" placeholder="Yang Menghadiri" value="<?php echo $undangan-> ?>">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input type="hidden" name="old_file" value="<?php echo $undangan->file ?>">
								<div class="invalid-feedback">

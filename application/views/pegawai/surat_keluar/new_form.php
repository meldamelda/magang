			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('pegawai/surat_keluar/') ?>">
					...
					<!-- card-header -->
					<div class="card-body">
						<form action="<?php base_url('pegawai/surat_keluar/add') ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('kode') ? 'is-invalid':'' ?>" type="text" name="kode" placeholder="Kode">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('tujuan') ? 'is-invalid':'' ?>" type="text" name="tujuan" placeholder="Tujuan">
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('perihal') ? 'is-invalid':'' ?>" type="text" name="perihal" placeholder="Perihal"></textarea>
								<div class="invalid-feedback">
							...
							<input class="btn btn-melda2" type="submit" name="btn" value="SIMPAN">
						</form>
					</div>
					<!-- card-body -->
				</div>

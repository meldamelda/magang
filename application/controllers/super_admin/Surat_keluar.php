<?php
	...
	class Surat_keluar extends CI_Controller{
		...
		public function index(){
			...
			$this->load->view("super_admin/surat_keluar/list", $data);
		}
		...
		public function add(){
			...
			$this->load->view("super_admin/surat_keluar/new_form");
		}

		public function edit($id = null){
			if(!isset($id)) redirect('super_admin/surat_keluar');
			...
			$this->load->view("super_admin/surat_keluar/edit_form", $data);
		}
		...
		public function delete($id = null){
			...
			if($this->surat_keluar_model->delete($id)){
				redirect(site_url('super_admin/surat_keluar'));
			}
		}
